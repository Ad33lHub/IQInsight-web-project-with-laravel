...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4 fade-rise">
        <div>
            ...
            <h2 class="fw-bold mb-0">Pick your next challenge</h2>
    ...
    <div class="fade-rise mb-4">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h5 class="mb-0">Freshly rotated</h5>
            <span class="text-secondary small">Every visit shows new picks</span>
        </div>
        <div class="row g-3">
    ...
    <div class="fade-rise">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-semibold mb-0">All quizzes</h4>
